...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),K=e('<hr><h2 id="what-is-ci-cd" tabindex="-1"><a class="header-anchor" href="#what-is-ci-cd"><span>What is CI/CD?</span></a></h2><ul><li>the pipeline goes through multiple stages: build, test &amp; deploy</li><li>right now, we consider the website hosted at AWS S3 our production environment</li><li>quite often, pipelines will also have a staging environment</li><li>a staging environment is a non-production, usually non-public environment that is very close to the actual production environment</li><li>we often use automation to create these environments and to ensure that they are indeed identical</li><li>we use a staging environment as a pre-production environment</li><li>essentially, we try out our deployment in the pre-production environment</li><li>CD can refer to two concepts: <ul><li>Continuous Deployment - where every change is automatically deployed to production</li><li>Continuous Delivery - where every change is automatically deployed to staging but where we need some manual intervention to deploy to production</li></ul></li></ul><hr><h2 id="assignment" tabindex="-1"><a class="header-anchor" href="#assignment"><span>Assignment</span></a></h2><ul><li>create a staging environment and add it to the CI/CD pipeline</li></ul><hr><h2 id="assignment-solution" tabindex="-1"><a class="header-anchor" href="#assignment-solution"><span>Assignment solution</span></a></h2>',8),H={class:"hint-container important"},Y=n("p",{class:"hint-container-title"},"Pipeline after this lecture",-1),J=e(`<code>.gitlab-ci.yml</code><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">stages</span><span class="token punctuation">:</span></span>
<span class="line">  <span class="token punctuation">-</span> build</span>
<span class="line">  <span class="token punctuation">-</span> test</span>
