import{_ as r}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,b as t,t as h,e as n,n as i,g as a,a as e,r as u,o as l}from"./app-BgNevrm5.js";const p={},d={id:"frontmatter-title-관련",tabindex:"-1"},m={class:"header-anchor",href:"#frontmatter-title-관련"},f=t("nav",{class:"table-of-contents"},[t("ul")],-1),g=t("hr",null,null,-1),y=t("blockquote",null,[t("p",null,"Available from iOS 8.0")],-1),w=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function b(s,k){const o=u("VPCard");return l(),c("div",null,[t("h1",d,[t("a",m,[t("span",null,h(s.$frontmatter.title)+" 관련",1)])]),n(o,i(a({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),f,g,n(o,i(a({title:"How to use Touch ID to authenticate users by fingerprint | System - free Swift example code",desc:"How to use Touch ID to authenticate users by fingerprint",logo:"https://hackingwithswift.com/favicon.svg",link:"https://hackingwithswift.com/example-code/how-to-use-touch-id-to-authenticate-users-by-fingerprint",background:"rgba(174,10,10,0.2)"})),null,16),y,e(" TODO: 작성 "),e(` 
