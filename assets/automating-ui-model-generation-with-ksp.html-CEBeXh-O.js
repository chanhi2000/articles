import{_ as m}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as p,d as e,f as i,a as o,t as g,n as r,g as l,e as t,r as s,o as u}from"./app-07NBz65r.js";const h={},f={id:"frontmatter-title-관련",tabindex:"-1"},w={class:"header-anchor",href:"#frontmatter-title-관련"};function v(d,n){const a=s("VPCard"),c=s("SiteInfo");return u(),p("div",null,[e("h1",f,[e("a",w,[e("span",null,g(d.$frontmatter.title)+" 관련",1)])]),i(a,r(l({title:"Android > Article(s)",desc:"Article(s)",link:"/programming/java-android/articles/README.md",logo:"/images/ico-wind.svg",background:"rgba(10,10,10,0.2)"})),null,16),n[0]||(n[0]=e("nav",{class:"table-of-contents"},[e("ul")],-1)),n[1]||(n[1]=e("hr",null,null,-1)),i(c,{name:"Automating UI Model Generation With KSP",desc:"In this article, we’ll explore how to generate UI presentation models directly from Composable function definitions using KSP. This approach helps us structure and model data within the presentation layer (ViewModel) in a way that naturally aligns with UI components, leading to reduced maintenance overhead.",url:"https://droidcon.com/2025/02/11/automating-ui-model-generation-with-ksp",logo:"https://droidcon.com/wp-content/uploads/2021/07/favicon-300x300.png",preview:"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png"}),n[2]||(n[2]=e("p",null,[e("img",{src:"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png",alt:"",loading:"lazy"}),t("Image was created with the assistance of DALL·E 3")],-1)),n[3]||(n[3]=e("p",null,[t("In this article, we’ll explore"),e("strong",null,"how to generate UI presentation models directly from Composable function definitions"),t(" using KSP**."),e("strong",null,"This approach helps us structure and model data within the presentation layer (ViewModel) in a way that naturally aligns with UI components, leading to"),t("reduced maintenance overhead**.")],-1)),n[4]||(n[4]=e("p",null,[t("By ensuring that our data models reflect the structure of the UI components, we ensure that business logic doesn’t leak into the view layer. Instead,"),e("strong",null,"all data formatting and manipulation will reside within the ViewModel"),t(", preventing common issues such as embedding UI-specific logic — like boolean visibility conditions, label changes, or style adjustments — directly in the view.")],-1)),n[5]||(n[5]=e("p",null,"This approach aligns with clean architecture principles, improving maintainability, enhancing code readability, and making testing easier and more efficient. By centralizing logic in the presentation layer, we reduce the reliance on UI tests.",-1)),o(` ###### ViewItems
...
**P.S.**Interested in working with us? We’re hiring![Check out our open Engineering roles here](https://wise.jobs/engineering). `),n[6]||(n[6]=e("p",null,[t("This article is previously published on "),e("a",{href:"https://proandroiddev.com/automating-ui-model-generation-with-ksp-4b1d9d1f5c95",target:"_blank",rel:"noopener noreferrer"},"proandroiddev.com.")],-1)),o(" TODO: add ARTICLE CARD "),i(a,r(l({title:"Automating UI Model Generation With KSP",desc:"In this article, we’ll explore how to generate UI presentation models directly from Composable function definitions using KSP. This approach helps us structure and model data within the presentation layer (ViewModel) in a way that naturally aligns with UI components, leading to reduced maintenance overhead.",link:"https://chanhi2000.github.io/bookshelf/droidcon.com/automating-ui-model-generation-with-ksp.html",logo:"https://droidcon.com/wp-content/uploads/2021/07/favicon-300x300.png",background:"rgba(4,20,221,0.2)"})),null,16)])}const I=m(h,[["render",v]]),R=JSON.parse('{"path":"/droidcon.com/automating-ui-model-generation-with-ksp.html","title":"Automating UI Model Generation With KSP","lang":"en-US","frontmatter":{"lang":"en-US","title":"Automating UI Model Generation With KSP","description":"Article(s) > Automating UI Model Generation With KSP","icon":"fa-brands fa-android","category":["Java","Kotlin","Android","Article(s)"],"tag":["blog","droidcon.com","java","kotlin","android"],"head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Automating UI Model Generation With KSP\\",\\"image\\":[\\"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png\\",\\"https://miro.medium.com/v2/resize:fit:800/format:webp/1*xC3sJ7fVC2EnEDho3ggDfw.png\\",\\"https://miro.medium.com/v2/resize:fit:1136/format:webp/1*F6K-0S5xpBwDSS7vdsoFlA.png\\",\\"https://wise.jobs/engineering\\"],\\"datePublished\\":\\"2025-02-12T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"João Cevada\\"}]}"],["meta",{"property":"og:url","content":"https://chanhi2000.github.io/bookshelf/droidcon.com/automating-ui-model-generation-with-ksp.html"}],["meta",{"property":"og:site_name","content":"📚Bookshelf"}],["meta",{"property":"og:title","content":"Automating UI Model Generation With KSP"}],["meta",{"property":"og:description","content":"Article(s) > Automating UI Model Generation With KSP"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:src","content":"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png"}],["meta",{"name":"twitter:image:alt","content":"Automating UI Model Generation With KSP"}],["meta",{"property":"article:author","content":"João Cevada"}],["meta",{"property":"article:tag","content":"android"}],["meta",{"property":"article:tag","content":"kotlin"}],["meta",{"property":"article:tag","content":"java"}],["meta",{"property":"article:tag","content":"droidcon.com"}],["meta",{"property":"article:tag","content":"blog"}],["meta",{"property":"article:published_time","content":"2025-02-12T00:00:00.000Z"}],[{"meta":null},{"property":"og:title","content":"Article(s) > Automating UI Model Generation With KSP"},{"property":"og:description","content":"Automating UI Model Generation With KSP"},{"property":"og:url","content":"https://chanhi2000.github.io/bookshelf/droidcon.com/automating-ui-model-generation-with-ksp.html"}]],"prev":"/programming/java-android/articles/README.md","date":"2025-02-12T00:00:00.000Z","isOriginal":false,"author":"João Cevada","cover":"https://miro.medium.com/v2/resize:fit:720/format:webp/1*fj37iju-vPqoHPAvPD6zFg.png"},"git":{},"readingTime":{"minutes":14.42,"words":4325},"filePathRelative":"droidcon.com/automating-ui-model-generation-with-ksp.md","copyright":{"author":"João Cevada"}}');export{I as comp,R as data};
