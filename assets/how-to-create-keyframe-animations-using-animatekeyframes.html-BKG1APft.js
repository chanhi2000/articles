...
`)],-1);function k(r,v){const a=l("VPCard");return h(),m("div",null,[e("h1",u,[e("a",d,[e("span",null,c(r.$frontmatter.title)+" 관련",1)])]),i(a,n(o({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),p,g,i(a,n(o({title:"How to create keyframe animations using animateKeyframes() | UIKit - free Swift example code",desc:"How to create keyframe animations using animateKeyframes()",link:"https://hackingwithswift.com/example-code/uikit/how-to-create-keyframe-animations-using-animatekeyframes",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),y,t(" TODO: 작성 "),t(`
