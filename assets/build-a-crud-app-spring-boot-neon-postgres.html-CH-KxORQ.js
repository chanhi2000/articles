import{_ as u}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as h,b as e,t as g,e as n,n as r,g as p,d as t,w as o,a as m,f,r as s,o as b}from"./app-BgNevrm5.js";const w={},y={id:"frontmatter-title-관련",tabindex:"-1"},v={class:"header-anchor",href:"#frontmatter-title-관련"},A=e("hr",null,null,-1),C={href:"https://neon.tech/",target:"_blank",rel:"noopener noreferrer"},S={href:"https://azure.microsoft.com/en-us/products/app-service",target:"_blank",rel:"noopener noreferrer"},z=f('<p>You&#39;ll learn how Neon Postgres can make your development and deployment processes easier along the way.</p><hr><h2 id="here-s-what-we-ll-cover" tabindex="-1"><a class="header-anchor" href="#here-s-what-we-ll-cover"><span>Here&#39;s what we&#39;ll cover:</span></a></h2><ul><li>Setting up a Neon Postgres database and exploring its features</li><li>Building a CRUD application using Spring Boot and deploying the application on Azure App Service</li><li>Why Neon is a good fit for infrastructure that auto-scales</li><li>Database branching in Neon Postgres and how it can ease the development workflow</li></ul><hr><h2 id="prerequisites" tabindex="-1"><a class="header-anchor" href="#prerequisites"><span>Prerequisites</span></a></h2><ul><li>Working knowledge of Java, Maven, and Spring Boot</li><li>Basics of SQL databases</li><li>Understanding of serverless and cloud services</li><li>Familiarity with testing and deployment processes</li></ul>',7),k={class:"table-of-contents"},N=e("hr",null,null,-1),R=e("h2",{id:"what-is-neon-postgres",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#what-is-neon-postgres"},[e("span",null,"What is Neon Postgres?")])],-1),F=e("p",null,"Neon is a fully managed serverless Postgres database platform. It offers features such as high availability, automatic backups, and scaling options to handle varying traffic levels.",-1),_=e("p",null,"Neon is designed to be cost-efficient and developer-friendly, and it focuses on providing a seamless experience for developers.",-1),D=e("p",null,"In addition to the standard Postgres features, it provides capabilities like database branching, allowing you to create Git-like branches of the database for different purposes.",-1),P=e("hr",null,null,-1),U=e("h2",{id:"how-to-set-up-the-database",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#how-to-set-up-the-database"},[e("span",null,"How to Set Up the Database")])],-1);function B(c,j){const i=s("VPCard"),d=s("SiteInfo"),l=s("FontIcon"),a=s("router-link");return b(),h("div",null,[e("h1",y,[e("a",v,[e("span",null,g(c.$frontmatter.title)+" 관련",1)])]),n(i,r(p({title:"Spring > Article(s)",desc:"Article(s)",link:"/programming/java-spring/articles/README.md",logo:"/images/ico-wind.svg",background:"rgba(10,10,10,0.2)"})),null,16),n(i,r(p({title:"PostgreSQL > Article(s)",desc:"Article(s)",link:"/data-science/postgres/articles/README.md",logo:"/images/ico-wind.svg",background:"rgba(10,10,10,0.2)"})),null,16),n(i,r(p({title:"Azure > Article(s)",desc:"Article(s)",link:"/devops/azure/articles/README.md",logo:"/images/ico-wind.svg",background:"rgba(10,10,10,0.2)"})),null,16),A,n(d,{name:"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service",desc:"In this article, we'll explore how to develop a CRUD (Create, Read, Update, Delete) application using Spring Boot and Neon Postgres. We'll also deploy the application on Azure App Service and make it production-ready by setting up features like autoscaling and multiple environments. You'll learn how Neon Postgres...",url:"https://freecodecamp.org/news/build-a-crud-app-spring-boot-neon-postgres/",logo:"https://cdn.freecodecamp.org/universal/favicons/favicon.ico",preview:"https://freecodecamp.org/news/content/images/size/w1000/2024/07/neon-banner.png"}),e("p",null,[t("In this article, we'll explore how to develop a CRUD (Create, Read, Update, Delete) application using Spring Boot and "),e("a",C,[n(l,{icon:"fas fa-globe"}),t("Neon Postgres")]),t(".")]),e("p",null,[t("We'll also deploy the application on "),e("a",S,[n(l,{icon:"iconfont icon-microsoftazure"}),t("Azure App Service")]),t(" and make it production-ready by setting up features like autoscaling and multiple environments.")]),z,e("nav",k,[e("ul",null,[e("li",null,[n(a,{to:"#here-s-what-we-ll-cover"},{default:o(()=>[t("Here's what we'll cover:")]),_:1})]),e("li",null,[n(a,{to:"#prerequisites"},{default:o(()=>[t("Prerequisites")]),_:1})]),e("li",null,[n(a,{to:"#what-is-neon-postgres"},{default:o(()=>[t("What is Neon Postgres?")]),_:1})]),e("li",null,[n(a,{to:"#how-to-set-up-the-database"},{default:o(()=>[t("How to Set Up the Database")]),_:1})])])]),N,R,F,_,D,P,U,m(`
...
`)])}const I=u(w,[["render",B],["__file","build-a-crud-app-spring-boot-neon-postgres.html.vue"]]),q=JSON.parse(`{"path":"/freecodecamp.org/build-a-crud-app-spring-boot-neon-postgres.html","title":"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service","lang":"ko-KR","frontmatter":{"lang":"ko-KR","title":"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service","description":"Article(s) > How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service","icon":"iconfont icon-spring","category":["Java","Spring","Spring Boot","PostgreSQL","Microsoft","Azure","Article(s)"],"tag":["blog","freecodecamp.org","java","spring","spring-boot","postgres","postgresql","microsoft","azure"],"head":[[{"meta":null},{"property":"og:title","content":"Article(s) > How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service"},{"property":"og:description","content":"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service"},{"property":"og:url","content":"https://chanhi2000.github.io/bookshelf/freecodecamp.org/build-a-crud-app-spring-boot-neon-postgres.html"}],["meta",{"property":"og:url","content":"https://chanhi2000.github.io/bookshelf/freecodecamp.org/build-a-crud-app-spring-boot-neon-postgres.html"}],["meta",{"property":"og:site_name","content":"📚Bookshelf"}],["meta",{"property":"og:title","content":"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service"}],["meta",{"property":"og:description","content":"Article(s) > How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://freecodecamp.org/news/content/images/size/w1000/2024/07/neon-banner.png"}],["meta",{"property":"og:locale","content":"ko-KR"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:src","content":"https://freecodecamp.org/news/content/images/size/w1000/2024/07/neon-banner.png"}],["meta",{"name":"twitter:image:alt","content":"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service"}],["meta",{"property":"article:tag","content":"blog"}],["meta",{"property":"article:tag","content":"freecodecamp.org"}],["meta",{"property":"article:tag","content":"java"}],["meta",{"property":"article:tag","content":"spring"}],["meta",{"property":"article:tag","content":"spring-boot"}],["meta",{"property":"article:tag","content":"postgres"}],["meta",{"property":"article:tag","content":"postgresql"}],["meta",{"property":"article:tag","content":"microsoft"}],["meta",{"property":"article:tag","content":"azure"}],["meta",{"property":"article:published_time","content":"2024-07-26T00:00:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"How to Develop a CRUD App with Spring Boot, Neon Postgres, and Azure App Service\\",\\"image\\":[\\"https://freecodecamp.org/news/content/images/size/w1000/2024/07/neon-banner.png\\"],\\"datePublished\\":\\"2024-07-26T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[]}"]],"prev":"/programming/java-spring/articles/README.md","date":"2024-07-26T00:00:00.000Z","isOriginal":false,"cover":"https://freecodecamp.org/news/content/images/size/w1000/2024/07/neon-banner.png"},"headers":[{"level":2,"title":"Here's what we'll cover:","slug":"here-s-what-we-ll-cover","link":"#here-s-what-we-ll-cover","children":[]},{"level":2,"title":"Prerequisites","slug":"prerequisites","link":"#prerequisites","children":[]},{"level":2,"title":"What is Neon Postgres?","slug":"what-is-neon-postgres","link":"#what-is-neon-postgres","children":[]},{"level":2,"title":"How to Set Up the Database","slug":"how-to-set-up-the-database","link":"#how-to-set-up-the-database","children":[]}],"git":{"contributors":[{"name":"chanhi2000","email":"chanhi2000@gmail.com","commits":2}]},"readingTime":{"minutes":10.45,"words":3134},"filePathRelative":"freecodecamp.org/build-a-crud-app-spring-boot-neon-postgres.md","localizedDate":"2024년 7월 26일","excerpt":"\\n"}`);export{I as comp,q as data};
