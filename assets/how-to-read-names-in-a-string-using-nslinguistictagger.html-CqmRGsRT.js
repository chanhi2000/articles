import{_ as r}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as g,b as t,t as c,e as i,n as a,g as o,a as e,r as l,o as m}from"./app-BgNevrm5.js";const u={},h={id:"frontmatter-title-관련",tabindex:"-1"},p={class:"header-anchor",href:"#frontmatter-title-관련"},d=t("nav",{class:"table-of-contents"},[t("ul")],-1),w=t("hr",null,null,-1),f=t("blockquote",null,[t("p",null,"Available from iOS 5.0")],-1),y=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function S(s,k){const n=l("VPCard");return m(),g("div",null,[t("h1",h,[t("a",p,[t("span",null,c(s.$frontmatter.title)+" 관련",1)])]),i(n,a(o({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),d,w,i(n,a(o({title:"How to read names in a string using NSLinguisticTagger | System - free Swift example code",desc:"How to read names in a string using NSLinguisticTagger",logo:"https://hackingwithswift.com/favicon.svg",link:"https://hackingwithswift.com/example-code/how-to-read-names-in-a-string-using-nslinguistictagger",background:"rgba(174,10,10,0.2)"})),null,16),f,e(" TODO: 작성 "),e(` 
