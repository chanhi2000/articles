import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,b as t,t as h,e as i,n,g as r,a as e,r as p,o as l}from"./app-BgNevrm5.js";const u={},d={id:"frontmatter-title-관련",tabindex:"-1"},m={class:"header-anchor",href:"#frontmatter-title-관련"},w=t("nav",{class:"table-of-contents"},[t("ul")],-1),y=t("hr",null,null,-1),f=t("blockquote",null,[t("p",null,"Available from iOS 9.0")],-1),g=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function S(a,T){const o=p("VPCard");return l(),c("div",null,[t("h1",d,[t("a",m,[t("span",null,h(a.$frontmatter.title)+" 관련",1)])]),i(o,n(r({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),w,y,i(o,n(r({title:"How to handle the HTTPS requirements in iOS with App Transport Security | System - free Swift example code",desc:"How to handle the HTTPS requirements in iOS with App Transport Security",link:"https://hackingwithswift.com/example-code/how-to-handle-the-https-requirements-in-ios-with-app-transport-security",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),f,e(" TODO: 작성 "),e(` 
