import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as l,b as t,t as c,e as n,n as i,g as r,a as e,r as h,o as f}from"./app-BgNevrm5.js";const w={},u={id:"frontmatter-title-관련",tabindex:"-1"},d={class:"header-anchor",href:"#frontmatter-title-관련"},p=t("nav",{class:"table-of-contents"},[t("ul")],-1),m=t("hr",null,null,-1),g=t("blockquote",null,[t("p",null,"Available from iOS 13.0")],-1),k=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function y(a,C){const o=h("VPCard");return f(),l("div",null,[t("h1",u,[t("a",d,[t("span",null,c(a.$frontmatter.title)+" 관련",1)])]),n(o,i(r({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),p,m,n(o,i(r({title:"How to let users choose a font with UIFontPickerViewController | UIKit - free Swift example code",desc:"How to let users choose a font with UIFontPickerViewController",link:"https://hackingwithswift.com/example-code/uikit/how-to-let-users-choose-a-font-with-uifontpickerviewcontroller",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),g,e(" TODO: 작성 "),e(`
