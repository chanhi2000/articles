import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,b as t,t as l,e as a,n,g as i,a as o,r as h,o as u}from"./app-BgNevrm5.js";const d={},p={id:"frontmatter-title-관련",tabindex:"-1"},g={class:"header-anchor",href:"#frontmatter-title-관련"},w=t("nav",{class:"table-of-contents"},[t("ul")],-1),m=t("hr",null,null,-1),y=t("blockquote",null,[t("p",null,"Available from iOS 11.0")],-1),f=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),o(`
...
`)],-1);function k(r,b){const e=h("VPCard");return u(),c("div",null,[t("h1",p,[t("a",g,[t("span",null,l(r.$frontmatter.title)+" 관련",1)])]),a(e,n(i({title:"Location - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/location/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),w,m,a(e,n(i({title:"How to read the user’s location while your app is in the background | Location - free Swift example code",desc:"How to read the user’s location while your app is in the background",link:"https://hackingwithswift.com/example-code/location/how-to-read-the-users-location-while-your-app-is-in-the-background",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),y,o(" TODO: 작성 "),o(` 
