import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,b as t,t as c,e as a,n as r,g as n,a as e,r as h,o as d}from"./app-BgNevrm5.js";const p={},w={id:"frontmatter-title-관련",tabindex:"-1"},u={class:"header-anchor",href:"#frontmatter-title-관련"},m=t("nav",{class:"table-of-contents"},[t("ul")],-1),b=t("hr",null,null,-1),f=t("blockquote",null,[t("p",null,"Available from iOS 7.0")],-1),g=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function y(i,v){const o=h("VPCard");return d(),s("div",null,[t("h1",w,[t("a",u,[t("span",null,c(i.$frontmatter.title)+" 관련",1)])]),a(o,r(n({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),m,b,a(o,r(n({title:"How do you show a modal view controller when a UITabBarController tab is tapped? | UIKit - free Swift example code",desc:"How do you show a modal view controller when a UITabBarController tab is tapped?",link:"https://hackingwithswift.com/example-code/uikit/how-do-you-show-a-modal-view-controller-when-a-uitabbarcontroller-tab-is-tapped",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),f,e(" TODO: 작성 "),e(`
