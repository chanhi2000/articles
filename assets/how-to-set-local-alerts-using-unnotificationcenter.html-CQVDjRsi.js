import{_ as r}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,b as t,t as l,e as o,n as i,g as a,a as e,r as h,o as u}from"./app-BgNevrm5.js";const f={},d={id:"frontmatter-title-관련",tabindex:"-1"},p={class:"header-anchor",href:"#frontmatter-title-관련"},g=t("nav",{class:"table-of-contents"},[t("ul")],-1),m=t("hr",null,null,-1),w=t("blockquote",null,[t("p",null,"Available from iOS 8.0")],-1),y=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function N(s,b){const n=h("VPCard");return u(),c("div",null,[t("h1",d,[t("a",p,[t("span",null,l(s.$frontmatter.title)+" 관련",1)])]),o(n,i(a({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),g,m,o(n,i(a({title:"How to set local alerts using UNNotificationCenter | System - free Swift example code",desc:"How to set local alerts using UNNotificationCenter",logo:"https://hackingwithswift.com/favicon.svg",link:"https://hackingwithswift.com/example-code/how-to-set-local-alerts-using-unnotificationcenter",background:"rgba(174,10,10,0.2)"})),null,16),w,e(" TODO: 작성 "),e(` 
