import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as r,b as t,t as l,e as n,n as i,g as a,a as e,r as p,o as h}from"./app-BgNevrm5.js";const m={},g={id:"frontmatter-title-관련",tabindex:"-1"},y={class:"header-anchor",href:"#frontmatter-title-관련"},f=t("nav",{class:"table-of-contents"},[t("ul")],-1),d=t("hr",null,null,-1),u=t("blockquote",null,[t("p",null,"Available from iOS 7.0")],-1),w=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function b(s,S){const o=p("VPCard");return h(),r("div",null,[t("h1",g,[t("a",y,[t("span",null,l(s.$frontmatter.title)+" 관련",1)])]),n(o,i(a({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),f,d,n(o,i(a({title:"How to copy objects in Swift using copy() | System - free Swift example code",desc:"How to copy objects in Swift using copy()",link:"https://hackingwithswift.com/example-code/system/how-to-copy-objects-in-swift-using-copy",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),u,e(" TODO: 작성 "),e(` 
