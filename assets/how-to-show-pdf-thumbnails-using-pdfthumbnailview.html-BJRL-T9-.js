import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as h,b as t,t as l,e as n,n as o,g as a,a as e,r as c,o as u}from"./app-BgNevrm5.js";const w={},m={id:"frontmatter-title-관련",tabindex:"-1"},d={class:"header-anchor",href:"#frontmatter-title-관련"},p=t("nav",{class:"table-of-contents"},[t("ul")],-1),f=t("hr",null,null,-1),g=t("blockquote",null,[t("p",null,"Available from iOS 11.0")],-1),b=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function D(r,P){const i=c("VPCard");return u(),h("div",null,[t("h1",m,[t("a",d,[t("span",null,l(r.$frontmatter.title)+" 관련",1)])]),n(i,o(a({title:"Libraries - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/libraries/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),p,f,n(i,o(a({title:"How to show PDF thumbnails using PDFThumbnailView | Libraries - free Swift example code",desc:"How to show PDF thumbnails using PDFThumbnailView",link:"https://hackingwithswift.com/example-code/libraries/how-to-show-pdf-thumbnails-using-pdfthumbnailview",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),g,e(" TODO: 작성 "),e(` 
