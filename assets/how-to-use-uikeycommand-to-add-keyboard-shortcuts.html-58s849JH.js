import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as d,b as t,t as c,e as a,n as s,g as i,a as e,r as l,o as h}from"./app-BgNevrm5.js";const m={},u={id:"frontmatter-title-관련",tabindex:"-1"},y={class:"header-anchor",href:"#frontmatter-title-관련"},p=t("nav",{class:"table-of-contents"},[t("ul")],-1),k=t("hr",null,null,-1),w=t("blockquote",null,[t("p",null,"Available from iOS 7.0")],-1),f=t("details",{class:"hint-container details"},[t("summary",null,"Similar solutions…"),e(`
...
`)],-1);function b(r,g){const o=l("VPCard");return h(),d("div",null,[t("h1",u,[t("a",y,[t("span",null,c(r.$frontmatter.title)+" 관련",1)])]),a(o,s(i({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),p,k,a(o,s(i({title:"How to use UIKeyCommand to add keyboard shortcuts | UIKit - free Swift example code",desc:"How to use UIKeyCommand to add keyboard shortcuts",link:"https://hackingwithswift.com/example-code/uikit/how-to-use-uikeycommand-to-add-keyboard-shortcuts",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),w,e(" TODO: 작성 "),e(`
